// ──────────────────────────────────────────────────────────────────────────────
// Backpack Dungeon — Comprehensive Integration Tests
//
// Tests cover:
//   1. Daily map generation (determinism, structure, POI distribution)
//   2. Merkle tree construction, proof generation, and verification
//   3. Enemy scaling, stat computation, cooldown, reward tiers
//   4. Shop pricing, stock management, restock logic, purchase validation
//   5. Boss shard indexing, damage computation, participation tiers
//   6. Battle simulation (player scaling, combat flow)
//   7. cNFT mint adapter (mock)
//   8. RNG determinism and weighted picking
//   9. End-to-end dungeon flow (generate → merkle → battle → clear → reward)
// ──────────────────────────────────────────────────────────────────────────────
...
import { simulateBattle } from "../apps/web/app/dungeon/battle-sim.js";
...
test("player stats scale with clear count", async () => {
  const { computePlayerStats } = await import("../apps/web/app/dungeon/battle-sim.js");
